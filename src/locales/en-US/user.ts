...
export default {
  ...
  'user.phoneFormatErrorHint': 'Format error: 8-16 numeric words, at least two of which are: letters/numbers/symbols',
  'user.phoneFormatHint': '8-16 numeric words, at least two of which are: letters/numbers/symbols',
  'user.confirmPassword': 'Confirm password',
  'user.initialPasswordDifferentConfirmPassword': 'The initial password is different from the confirm password',
  'user.associatedSite': 'Associated site',
  'user.customRole': 'Custom Role',
  'user.predefinedRoles': 'Predefined Role',
  'user.deleteRoleConfirm': 'Are you sure you want to delete this role? Cannot be recovered after deletion!',
