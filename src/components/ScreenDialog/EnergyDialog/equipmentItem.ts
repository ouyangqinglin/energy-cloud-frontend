...
export const measureItems: DetailItem[] = [
  ...
  { label: '交流A相视在功率', field: 'Sa', format: kVAFormat },
  { label: '交流B相视在功率', field: 'Sb', format: kVAFormat },
  { label: '交流C相视在功率', field: 'Sc', format: kVAFormat },
  { label: '交流A相无功功率', field: 'Qa', format: noPowerFormat },
  { label: '交流B相无功功率', field: 'Qb', format: noPowerFormat },
  { label: '交流C相无功功率', field: 'Qc', format: noPowerFormat },
  { label: '交流输出总有功功率', field: 'P', format: powerFormat },
  { label: '交流输出总无功功率', field: 'Q', format: noPowerFormat },
  { label: '交流输出总视在功率', field: 'S', format: kVAFormat },
