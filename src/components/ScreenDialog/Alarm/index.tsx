...
const levelMap = new Map([
  ['info', <span className={styles.info}>{formatMessage({ id: 'alarmManage.tips', defaultMessage: '提示' })}</span>],
  ['warn', <span className={styles.warn}>{formatMessage({ id: 'alarmManage.secondary', defaultMessage: '次要' })}</span>],
  ['alarm', <span className={styles.alarm}>{formatMessage({ id: 'alarmManage.importance', defaultMessage: '重要' })}</span>],
  ['error', <span className={styles.error}>{formatMessage({ id: 'alarmManage.serious', defaultMessage: '严重' })}</span>],
]);
