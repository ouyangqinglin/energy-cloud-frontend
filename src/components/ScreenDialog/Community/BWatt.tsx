  ...
  const columns = useMemo<ProFormColumnsType<CommunityType>[]>(() => {
    const result: ProFormColumnsType<CommunityType>[] = [
      ...
      },
      {
        ...
        dataIndex: 'projectId',
        formItemProps: {
          rules: [{ required: true, message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入' })+formatMessage({ id: 'device.item', defaultMessage: '项目' }) + ' ID' }],
        },
      },
      {
        title: 'BMS ID',
        dataIndex: 'bmsId',
        formItemProps: {
          rules: [{ required: true, message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入' })+'BMS ID' }],
        },
      },
      {
        title: 'EMS ID',
        dataIndex: 'emsId',
        formItemProps: {
          rules: [{ required: true, message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入' })+'EMS ID' }],
        },
      },
      {
        title: 'PCS ID',
        dataIndex: 'pcsId',
        formItemProps: {
          rules: [{ required: true, message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入' })+'PCS ID' }],
        },
      },
      {
        ...
        formItemProps: {
          rules: [{ required: true, message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入' })+formatMessage({ id: 'device.cellTemperature', defaultMessage: '单体温度' })+' ID' }],
        },
      },
      {
        ...
        formItemProps: {
          rules: [{ required: true, message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入' })+formatMessage({ id: 'device.cellVoltage', defaultMessage: '单体电压' })+' ID' }],
        },
      },
      {
        ...
        formItemProps: {
          rules: [{ required: true, message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入' })+formatMessage({ id: 'device.airConditioner', defaultMessage: '空调' })+' ID' }],
        },
      },
      {
        ...
        formItemProps: {
          rules: [{ required: true, message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入' })+formatMessage({ id: 'device.systemClock', defaultMessage: '系统时钟' })+' ID' }],
        },
      },
      {
        title: formatMessage({ id: 'device.energyConsumptionStatistics', defaultMessage: '能耗统计' })+' ID',
        dataIndex: 'statisticsDeviceId',
        formItemProps: {
          rules: [{ required: true, message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入' })+formatMessage({ id: 'device.energyConsumptionStatistics', defaultMessage: '能耗统计' })+' ID' }],
        },
      },
      {
