  ...
  const columns: ProFormColumnsType<MeterCommunityType>[] = [
    {
      ...
      dataIndex: 'userName',
      formItemProps: {
        rules: [{ required: true, message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请填写' }) + userLabel }],
      },
    },
    {
      title: passwordLabel,
      ...
      valueType: 'password',
      formItemProps: {
        rules: [{ required: true, message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请填写' }) + passwordLabel }],
      },
    },
  ];
