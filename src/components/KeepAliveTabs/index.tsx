...
const KeepAliveTabs = () => {
  ...
  const menu = (
    ...
    >
      <Menu.Item key="closeCurrent">{formatMessage({ id: 'common.closeCurrentLabel', defaultMessage: '关闭当前标签' })}</Menu.Item>
      <Menu.Item key="closeOther">{formatMessage({ id: 'common.closeOtherTags', defaultMessage: '关闭其他标签' })}</Menu.Item>
      <Menu.Item key="closeAll">{formatMessage({ id: 'common.closeAllTags', defaultMessage: '关闭全部标签' })}</Menu.Item>
