...
export const airItem = {
  ...
  data: [
    ...
    { label: formatMessage({ id: 'siteMonitor.returnAirHumidity', defaultMessage: '回风湿度' }) + '：', field: 'ReturnAirHumidity', format: wetFormat },
  ],
};
...
export const bwattAirItem = {
  ...
  data: [
    ...
    { label: formatMessage({ id: 'siteMonitor.roomTemperature', defaultMessage: '室内温度' }) + '：', field: 'IndoorTemperature', format: tempFormat },
    { label: formatMessage({ id: 'siteMonitor.humidness', defaultMessage: '湿度' }) + '：', field: 'Humidity', format: wetFormat },
  ],
};
...
export const unitItems = [
  ...
  },
  {
    ...
    data: [
      ...
      { label: formatMessage({ id: 'siteMonitor.storagePower', defaultMessage: '储能功率' }) +'：', field: 'P', format: energyPowerFormat },
    ],
  },
  {
    ...
    data: [
      { label: formatMessage({ id: 'siteMonitor.maxVoltage', defaultMessage: '最高电压' }) + '：', field: 'MVVOASU', format: voltageFormat },
      { label: formatMessage({ id: 'siteMonitor.numberCode', defaultMessage: '编号' }) +'：', field: 'MaxNOIV' },
      { label: formatMessage({ id: 'siteMonitor.minVoltage', defaultMessage: '最低电压' }) +'：', field: 'MVVOSU', format: voltageFormat },
      { label: formatMessage({ id: 'siteMonitor.numberCode', defaultMessage: '编号' }) +'：', field: 'MNOIV' },
      { label: formatMessage({ id: 'siteMonitor.maxTemperature', defaultMessage: '最高温度' }) +'：', field: 'MaximumIndividualTemperature', format: tempFormat },
      { label: formatMessage({ id: 'siteMonitor.numberCode', defaultMessage: '编号' }) +'：', field: 'MITN' },
      { label: formatMessage({ id: 'siteMonitor.minTemperature', defaultMessage: '最低温度' }) +'：', field: 'LVOMT', format: tempFormat },
      { label: formatMessage({ id: 'siteMonitor.numberCode', defaultMessage: '编号' }) +'：', field: 'MNOIT' },
    ],
  },
];
