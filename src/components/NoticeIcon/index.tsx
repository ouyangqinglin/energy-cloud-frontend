...
const NoticeIconView = () => {
  ...
  const clearReadState = (title: string, key: string) => {
    ...
    message.success(`${formatMessage({ id: 'common.cleared', defaultMessage: '清空了' })} ${title}`);
  };
  ...
  return (
    ...
    >
      <NoticeIcon.Tab
        ...
        emptyText={formatMessage({ id: 'common.viewedAllNotifications', defaultMessage: '你已查看所有通知' })}
        showViewMore
      />
      <NoticeIcon.Tab
        tabKey="message"
        ...
        emptyText={formatMessage({ id: 'common.readAllMessages', defaultMessage: '您已读完所有消息' })}
        showViewMore
      />
      <NoticeIcon.Tab
        tabKey="event"
        title={formatMessage({ id: 'common.backlog', defaultMessage: '待办' })}
        emptyText={formatMessage({ id: 'common.completedAllBacklog', defaultMessage: '你已完成所有待办' })}
