...
const SystemSetting: React.FC<StackProps> = (props) => {
  ...
  const detailGroup = useMemo<GroupItem[]>(() => {
    return [
      {
        label: <Detail.Label title="电池系统使能设置"><Button type="primary">配置参数</Button></Detail.Label>,
        items: protectParamsItems,
      },
      {
        label: <Detail.Label title="电池保护参数设置"><Button type="primary">配置参数</Button></Detail.Label>,
