...
const SystemSetting: React.FC<StackProps> = (props) => {
  ...
  const detailGroup = useMemo<GroupItem[]>(() => {
    return [
      {
        label: <Detail.Label title="手动模式设置"><Button type="primary">"下发参数"</Button></Detail.Label>,
        items: protectParamsItems,
      },
      {
        label: <Detail.Label title="削峰填谷模式设置"><Button type="primary">"下发参数"</Button></Detail.Label>,
        items: protectParamsItems,
      },
      {
        label: <Detail.Label title="备电模式设置"><Button type="primary">"下发参数"</Button></Detail.Label>,
        items: protectParamsItems,
      },
      {
        label: <Detail.Label title="尖峰平谷时段设置"><Button type="primary">"配置参数"</Button></Detail.Label>,
        items: protectParamsItems,
      },
      {
