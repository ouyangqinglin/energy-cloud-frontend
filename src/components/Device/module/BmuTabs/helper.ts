 ...
 * @LastEditTime: 2024-05-08 15:04:31
...
const LiquidEnergy232BatteryPackConfig = [
  tempText + 1,
  cellText + 1,
  tempText + 2,
  cellText + 2,
...
export const labelMap = new Map<DeviceTypeEnum | undefined, string[]>([
  [DeviceTypeEnum.LiquidEnergy232BatteryPack, LiquidEnergy232BatteryPackConfig],
  [
  ...
  [DeviceTypeEnum.LiquidEnergy232ABatteryPack, LiquidEnergy232BatteryPackConfig],
]);
