...
export const columns: ProColumns<DataType>[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        title: getLevelByType('error', { background: 'transparent' }),
        dataIndex: 'historyErrorNum',
        ellipsis: true,
        hideInSearch: true,
      },
      {
        title: getLevelByType('alarm', { background: 'transparent' }),
        dataIndex: 'historyAlarmNum',
        ellipsis: true,
        hideInSearch: true,
      },
      {
        title: getLevelByType('warn', { background: 'transparent' }),
        dataIndex: 'historyWarnNum',
        ellipsis: true,
        hideInSearch: true,
      },
      {
        title: getLevelByType('info', { background: 'transparent' }),
