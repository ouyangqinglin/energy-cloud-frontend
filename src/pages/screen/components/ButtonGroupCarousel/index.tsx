    ...
    <Cell width={112} height={36} left={474} top={253} zIndex={3}>
      ...
      >
        {screenConfigData?.energyFlowDiagramIds?.includes?.(2 as any) && (
          <Tooltip placement="top" title={formatMessage({ id: 'screen.customizedEnergyFlowChart', defaultMessage: '定制能流图' })} color="#0f60a7">
        ...
        {screenConfigData?.energyFlowDiagramIds?.includes?.(1 as any) && (
          <Tooltip placement="top" title={formatMessage({ id: 'screen.standardEnergyFlowChart', defaultMessage: '标准能流图' })} color="#0f60a7">
