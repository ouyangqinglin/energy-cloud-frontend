...
const elecNameMap = new Map([
  ...
  ['pvPowerGeneration', formatMessage({ id: 'device.pvPowerGeneration', defaultMessage: '光伏发电' })],
...
const SystemRun: React.FC = () => {
  ...
  const chartOption = useMemo(() => {
    return {
      ...
      yAxis: {
        name: timeType === TimeType.DAY ? formatMessage({ id: 'common.unit', defaultMessage: '单位'}) + '（kW）' : formatMessage({ id: 'common.unit', defaultMessage: '单位'})+'（kWh）',
        nameTextStyle: {
          color: '#ACCCEC',
        },
        splitLine: {
