...
const Income: React.FC = () => {
  ...
  return (
    <>
      <Title className="mt6 mb8" title={formatMessage({ id: 'screen.siteRevenue', defaultMessage: '站点收益' })} unit={`${formatMessage({ id: 'common.unit', defaultMessage: '单位'})}${formatMessage({id: 'common.rmb', defaultMessage: '元'})}`} />
