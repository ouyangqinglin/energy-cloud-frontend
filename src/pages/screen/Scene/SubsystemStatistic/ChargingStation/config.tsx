...
export const config: DigitalFlipperItemProps[] = [
  ...
  {
    title: formatMessage({ id: 'screen.chargingPowerUtilizationRate', defaultMessage: '充电桩功率利用率' }),
    field: 'useRatio',
    floatLength: 2,
...
export const realTimeStatisticConfig: DigitalFlipperItemProps[] = [
  {
    title: formatMessage({ id: 'siteMonitor.chargingPileRealtimePower', defaultMessage: '充电桩实时功率' }) + '：',
    field: 'power',
    unit: 'kW',
    floatLength: 2,
    numStyle: {
  ...
  {
    title: formatMessage({ id: 'screen.chargingGunUsageTotalNumber', defaultMessage: '充电枪使用/总数' }) + '：',
    field: 'occupyCount',
    render: (num, entity) => {
      return (
        <>
