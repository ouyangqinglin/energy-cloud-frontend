    ...
    <>
      <Cell width={170} height={42} left={40} top={90}>
        <div className={classnames([styles.boxWrapper, styles.boxBackgroundMini])}>
          <div className={styles.box}>
            <span className={styles.label}>{formatMessage({ id: 'screen.powerGrid', defaultMessage: '电网功率' })}(kW)：</span>
      ...
      <Cell width={170} height={66} left={40} top={302}>
        <div className={styles.boxWrapper}>
          <div className={styles.box}>
            <span className={styles.label}>{formatMessage({ id: 'screen.powerGeneration', defaultMessage: '发电功率' })}(kW)：</span>
            <span className={styles.value}>{pv?.p ?? '--'}</span>
          </div>
          <div className={styles.box}>
            <span className={styles.label}>{formatMessage({ id: 'screen.dailyPowerGeneration', defaultMessage: '当日发电' })}(kWh)：</span>
      ...
      <Cell width={170} height={66} left={766} top={90}>
        <div className={styles.boxWrapper}>
          <div className={styles.box}>
            <span className={styles.label}>{formatMessage({ id: 'screen.energyStoragePower', defaultMessage: '储能功率' })}(kW)：</span>
      ...
      <Cell width={170} height={42} left={766} top={302}>
        <div className={classnames([styles.boxWrapper, styles.boxBackgroundMini])}>
          <div className={styles.box}>
            <span className={styles.label}>{formatMessage({ id: 'screen.powerConsumption', defaultMessage: '用电功率' })}(kW)：</span>
