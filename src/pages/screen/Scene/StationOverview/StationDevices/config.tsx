...
export const DEFAULT_DATA = {
  bodyData: [
    [formatMessage({ id: 'device.pv', defaultMessage: '光伏'}), [formatMessage({ id: 'screen.inverter', defaultMessage: '逆变器' }), formatMessage({ id: 'screen.pvModule', defaultMessage: '光伏模组'})], ['1', '1']],
    [formatMessage({ id: 'device.storage', defaultMessage: '储能' }), ['Smart215-P0100A'], ['1']],
    [formatMessage({ id: 'device.chargingPile', defaultMessage: '充电桩' }), ['120kW', '160kW', '600kW'], ['1', '1', '1']],
  ],
  header: [formatMessage({ id: 'screen.subsystem', defaultMessage: '子系统' }), formatMessage({ id: 'screen.deviceName', defaultMessage: '设备名称'}), formatMessage({ id: 'screen.quantity', defaultMessage: '数量'})],
};
...
export const config: DeviceConfigItem[] = [
  ...
  },
  {
    ...
    child: [
      {
        dividerSpan: 4,
        title: formatMessage({ id: 'screen.pvInvertersCapacity', defaultMessage: '光伏逆变器数量' }),
