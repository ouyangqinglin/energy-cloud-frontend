...
export const detailItems: DetailItem[] = [
  ...
  { label: formatMessage({ id: 'common.productType', defaultMessage: '产品类型' }), field: 'productType' },
  { label: formatMessage({ id: 'user.productId', defaultMessage: '产品ID' }), field: 'id' },
  { label: formatMessage({ id: 'user.inputTime', defaultMessage: '录入时间' }), field: 'createTime' },
];
