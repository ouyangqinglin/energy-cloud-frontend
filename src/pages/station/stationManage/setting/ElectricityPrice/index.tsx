...
const Customer: React.FC = () => {
  ...
  const category: TabsProps['items'] = [
    {
      label: formatMessage({ id: 'siteManage.set.electricPriceSetting', defaultMessage: '市电电价设置' }),
      key: TabKeys.MARKET,
      children: <PriceMarketList actionRef={marketActionRef} />,
    },
    {
      label: formatMessage({ id: 'siteManage.set.pvGridElectricityPriceSetting', defaultMessage: '光伏上网电价设置' }),
      key: TabKeys.PHOTOVOLTAIC,
      children: <PricePhotovoltaicList actionRef={photovoltaicActionRef} />,
    },
    {
      label: formatMessage({ id: 'siteManage.set.chargePileChargingSettings', defaultMessage: '充电桩计费设置' }),
