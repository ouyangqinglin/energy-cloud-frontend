...
export const columns: YTProColumns<PhotovoltaicElectricityPriceInfo>[] = [
  ...
  },
  {
    ...
    valueEnum: new Map<number, ReactNode>([
      [1, <Badge status="success" key="success" text={formatMessage({ id: 'common.effect', defaultMessage: '生效' })} />],
      [0, <Badge status="error" key="error" text={formatMessage({ id: 'common.ineffect', defaultMessage: '未生效' })} />],
    ]),
  },
];
