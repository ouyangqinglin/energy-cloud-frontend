...
export const columns: YTProColumns<MarketElectricityPriceInfo>[] = [
  ...
  },
  {
    ...
    valueEnum: new Map<number, ReactNode>([
      ...
      [1, <Badge status="success" text={formatMessage({ id: 'common.effect', defaultMessage: '生效' })} />],
      // eslint-disable-next-line react/jsx-key
      [0, <Badge status="error" text={formatMessage({ id: 'common.ineffect', defaultMessage: '未生效' })} />],
    ]),
  },
];
