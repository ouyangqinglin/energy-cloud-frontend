...
import { getMaintenanceWorkOrder, updateMaintenanceWorkOrder, createMaintenance } from '../service';
...
export const MaintenanceUpdate = (
  props: FormUpdateBaseProps<MaintenanceListType> & { siteId: number; maintenanceId: number },
) => {
