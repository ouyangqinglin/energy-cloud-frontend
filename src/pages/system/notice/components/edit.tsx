    ...
    >
      <Form form={form} onFinish={handleFinish} initialValues={props.values} layout="vertical">
        <ProFormDigit
          ...
          placeholder={`${formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入'})}${intl.formatMessage({
            id: 'system.Notice.notice_id',
            defaultMessage: '公告ID',
          })}`}
          disabled
          ...
          rules={[
            {
              required: false,
              message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入'}) + formatMessage({ id: 'system.Notice.notice_id', defaultMessage: '公告ID'})
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: true,
              message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入'}) + formatMessage({ id: 'system.Notice.notice_title', defaultMessage: '公告标题'})
            },
          ]}
        />
        <ProFormSelect
          ...
          rules={[
            {
              required: true,
              message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入'}) + formatMessage({ id: 'system.Notice.notice_type', defaultMessage: '公告类型'})
            },
          ]}
        />
        <ProFormTextArea
          ...
          rules={[
            {
              required: false,
              message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入'}) + formatMessage({ id: 'system.Notice.notice_content', defaultMessage: '公告内容'})
            },
          ]}
        />
        <ProFormRadio.Group
          ...
          rules={[
            {
              required: false,
              message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入'}) + formatMessage({ id: 'system.Notice.status', defaultMessage: '公告状态'})
            },
          ]}
        />
        <ProFormText
          ...
          rules={[
            {
              required: false,
              message: formatMessage({ id: 'common.pleaseEnter', defaultMessage: '请输入'}) + formatMessage({ id: 'system.Notice.remark', defaultMessage: '备注'})
