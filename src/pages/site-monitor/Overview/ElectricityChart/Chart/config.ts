...
export const barLegendMap = new Map([
  ['charge', formatMessage({ id: 'siteMonitor.SelfGeneratedElectriConsumption', defaultMessage: '充电量' })],
  ['discharge', formatMessage({ id: 'siteMonitor.SelfGeneratedElectriConsumption', defaultMessage: '放电量' })],
  ['selfUse', formatMessage({ id: 'siteMonitor.SelfGeneratedElectriConsumption', defaultMessage: '自发自用电量' })],
  ['pvPowerGeneration', formatMessage({ id: 'siteManage.set.pvPowerGeneration', defaultMessage: '光伏发电量' })],
]);
...
export const barFieldMap: ChartConfigType[] = [
  {
    name: formatMessage({ id: 'siteMonitor.SelfGeneratedElectriConsumption', defaultMessage: '自发自用电量' }),
    field: 'pvSelfUse',
    flag: FlagType.PHOTOVOLTAIC_TYPE,
    show: false,
  },
  ...
  {
    name: formatMessage({ id: 'siteManage.set.energyStorageDischarge', defaultMessage: '储能放电量' }),
    field: 'essDisCharge',
    flag: FlagType.ES_TYPE,
    show: false,
  },
  {
    name: formatMessage({ id: 'siteMonitor.chargingPileChargingAmount', defaultMessage: '充电桩充电量' }),
    field: 'cpCharge',
    flag: FlagType.CHARGING_TYPE,
    show: false,
  },
  {
    name: formatMessage({ id: 'siteMonitor.otherLoadElectricConsumption', defaultMessage: '其他负载用电量' }),
    field: 'loadUse',
    flag: FlagType.LOAD_TYPE,
    show: false,
  },
