...
const keyToSystemTitle = new Map([
  ['11', formatMessage({id: 'siteMonitor.YongtaiLightEnergyStorage', defaultMessage: '永泰光储能示范站能量流'})],
  ['31', formatMessage({id: 'siteMonitor.storageSiteEnergyFlow', defaultMessage: '储能站点能量流'})],
    ...
    <>
      <div className="bg-white card-wrap p24">
        ...
        <div className={styles.stationHeader}>
          ...
          <Button type="primary">{formatMessage({ id: 'common.edit', defaultMessage: '编辑'})}</Button>
        </div>
